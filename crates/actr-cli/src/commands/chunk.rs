use actr_api::{ChunkPatchRequest, ChunkUpsertRequest};
...
pub async fn run(
    ...
    match matches.subcommand() {
        ...
        _ => Err(CliError::usage(
            ...
            "Use: actr-memory chunk put|get|patch|delete\nExplore: actr-memory chunk --help",
        )),
    }
}
...
async fn delete(
    ...
    if !matches.get_flag("yes") {
        return Err(CliError::usage(
            ...
            "Use: actr-memory --agent <agent-id> chunk delete <chunk-id> --yes",
        ));
    }
